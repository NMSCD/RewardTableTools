...
<template>
	<dialog ref="dialogElement" id="explanation" class="modal-content">
		...
		<p>
			To find out what item a specific product ID corresponds to, or to find the product ID of a specific item,
			you can use the <a href="https://app.nmsassistant.com/catalogue" target="_blank" rel="noopener noreferrer"
				title="Assistant for NMS">Assistant for NMS web app</a>. On every item is a "&lt;&gt;" icon in the top
